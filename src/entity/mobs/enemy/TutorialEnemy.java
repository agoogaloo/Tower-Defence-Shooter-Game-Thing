...
public class TutorialEnemy extends Enemy {
	...
	public TutorialEnemy(int x, int y, char direction, double speed, int reloadTime) {
		this(x,y,direction,speed,reloadTime,1);
		
	}
	public TutorialEnemy(int x, int y, char direction, double speed, int reloadTime, int health) {
		super(x, y, direction);
