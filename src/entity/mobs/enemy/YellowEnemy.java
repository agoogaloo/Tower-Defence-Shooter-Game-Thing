...
public class YellowEnemy extends Enemy{
	...
	public YellowEnemy(int x, int y, char direction) {
		...
		animDown = new Animation(Assets.enemyYellowD,4); //Different animations depending on the direction the enemy is facing
		animLeft = new Animation(Assets.enemyYellowL,4);
		animUp = new Animation(Assets.enemyYellowU,4);
		animRight = new Animation(Assets.enemyYellowR,4);
