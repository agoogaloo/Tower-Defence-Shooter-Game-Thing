...
//@author Matthew (trueX, trueY, width, height
...
public class Bullet extends Mobs{
	...
	public Bullet(int startX,int startY,double targetX,double targetY, int width, int height, int pics, int speed){ //Bullet class, can calculate how the bullet travels and which bullet picture to use
		this.speed = speed;
		this.width = width;
		this.height = height;
