...
public class WallD extends Tower{
	TowerSpawn platform;

	public WallD(int x, int y) {
		this(x,y,null);
		
	}
	
	public WallD(int x, int y, TowerSpawn spawn) {
		super(x, y, 0,0,new Animation(new BufferedImage[] { Assets.wallHor},6), 0,spawn);
		platform = new TowerSpawn(x-Assets.towerSpawn[0].getWidth()/2+2, y-Assets.towerSpawn[0].getHeight()/2+41,true);
